# These tests are copied from https://github.com/lgiordani/simple_calculator/blob/master/tests/test_main.py
# To be used as a simple exercise to try test driven development
